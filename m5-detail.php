...
<body>
    ...
    <section id="m1-detail" class="section-p1">
       <h2>FOR <span>BACK</span>PAIN</h2>
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/allen_back_pain_care_combo_pack_a67_relax_pain_killer_oil_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          <h4>Allen Back Pain Care Combo Pack (A67 + Relax Pain Killer Oil)</h4>
          <h4> ₹ 243.00</h4>
        
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWTTbpYJvXfzGP" async> </script> </form>
          <h4>Product details</h4>
          <span>
            Pain or discomfort in the upper, middle or lower back. Upper Back Pain (affecting the area of the cervical and thoracic spine), Middle Back Pain (affecting the area of a dorsal spine) and Lower Back Pain or Lumbago (affecting the area of the lumbosacral spine).
          </span>
        </div>
      </div>
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/amrutanjan_advanced_back_pain_roll_on_50_ml_0_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          <h4>Amrutanjan Advanced Back Pain + Roll-On 50 m</h4>
          <h4> ₹ 90.00</h4>
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWTZNhbq5XAD7t" async> </script> </form>
          <h4>Product details</h4>
          <span>
            ...
            Twin Axis Roller ball technology. Bigger ball size for application on larger area. Safe on skin & stain free
                 easy to hold and apply, deep penetration, unique formula for faster reliefnon messy hands,easy to carry.
          </span>
        </div>
      </div>
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/combiflam_icyhot_spray_35_gm_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          <h4>Combiflam Icyhot Spray 35 gm</h4>
          <h4> ₹ 112.19</h4>
          
         
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWTbkhXIOqOZBX" async> </script> </form>
          <h4>Product details</h4>
          <span>
       ...
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/sri_sri_tattva_vedanantaka_balm_30_gm_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          <h4>Sri Sri Tattva Vedanantaka Balm 30 gm</h4>
          <h4>₹ 76.00</h4>
          
          <div>
       
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWTdSKRzwIcSDy" async> </script> </form></div>
          <h4>Product details</h4>
          <span>
