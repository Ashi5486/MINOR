...
<body>
    ...
    <section id="m1-detail" class="section-p1">
       <h2>FOR <span>FE</span>VER</h2>
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/calpol_500mg_tablet_15_s_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          ...
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWVEDdtqcwkYNF" async> </script> </form>
       ...
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/feveryl_150_injection_2ml_456887_0_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          <h4>FEVERYL 150 Injection </h4>
          <h4>  ₹ 5.79</h4>
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWVFshO0jmbrCd" async> </script> </form>
          <h4>Product details</h4>
          <span>
       ...
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/paracip_500mg_tablet_10s_430793_1_2.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          ...
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWVGjSl4BkSf18" async> </script> </form>
          <h4>Product details</h4>
          <span>
            DOLO 650MG TABLET contains Paracetamol which belongs to the group of medicines called Analgesics and Antipyretics. It is used to relieve mild to moderate pain (including headaches, backache, toothache, severe nerve pain, sore throat, period pain, low back and leg pain, muscle, connective tissue and joint pain, symptomatic relief of sprains, strain, joint swelling and stiffness). It is also used to lower fever (high body temperature) and relieve cold or flu symptoms.
          </span>
       ...
       <div class="m1-detail-box">
        <div class="m1-left">
          <img src="img/pyrigesic_1gm_tablet_10_s_0.jpg" alt="">
        </div>
        <div class="m1-right">
          <h6>Medicine</h6>
          <h4>Pyrigesic 1000 Tablet 10'S</h4>
          <h4>  ₹ 27.20</h4>
          
          <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KWVKHlmSio48ms" async> </script> </form>
          <h4>Product details</h4>
          <span>
